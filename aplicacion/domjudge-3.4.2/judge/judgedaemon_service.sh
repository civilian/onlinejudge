...
JUDGEHOST_DIR="/home/invitado/public_html/domjudge/judgehost"

PIDID=`pgrep -f "judgedaemon"`
RUN_CMD="php $JUDGEHOST_DIR/lib/judge/judgedaemon.main.php -d"
RETVAL=0
prog="judgedaemon.main"
