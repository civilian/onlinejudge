...
--
-- Table structure for table `documentation_style`
--
...
CREATE TABLE IF NOT EXISTS `documentation_style` (
  ...
  `owner` int(8) NOT NULL DEFAULT '-1' COMMENT 'professor responsible of this style',
...
--
-- Table structure for table `indentation_style`
--
...
CREATE TABLE IF NOT EXISTS `indentation_style` (
  ...
  PRIMARY KEY (`indentation_styleid`),
  UNIQUE KEY `id` (`indentation_styleid`),
  UNIQUE KEY `style-langid` (`name`,`langid`)
...
CREATE TABLE `testcase` (
  ...
  `mdl_testcaseid` int(4) DEFAULT NULL COMMENT 'Moodle online judge testcase id',
  ...
  UNIQUE KEY `mdl_testcaseid` (`mdl_testcaseid`),
  KEY `probid` (`probid`),
