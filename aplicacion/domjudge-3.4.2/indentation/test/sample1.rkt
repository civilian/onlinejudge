	...
	(define functi ; look a funtcion

	  (lambda (jogador carta)(append (list 
				                 ...
				                 carta)
							         ...
							         (if (figura-carta?-sol carta)
								         ...
								         (let ((figura (valor-carta-sol carta)))
									           ...
									           (cond ((string=? figura "as") 13)

										                   ((string=? figura "rei") 12)

												                   ((string=? figura "valete") 11)

														                   ((#t 10))))  ; chegando aqui, é dama.

																                   (sub1 (valor-carta-sol carta)))))

																		   (define functi2 ; look a funtcion
																		     (lambda (var1 var2) 
																		         (lambda (foo)
																			       "foo"
																			             "bar")) 
																				       ...
																				       (define functiWhile ; look a funtcion
																				         (lambda (var1 var2) 
																					     (while (foo)
																					           "foo"
																						         "bar")
																							     ...
																							     (define functiIf ; look a funtcion
																							       (lambda (var1 var2) 
																							           (if (foo)
																								           "foo"
																									         "bar")
