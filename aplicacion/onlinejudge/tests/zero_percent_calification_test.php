...
class local_onlinejudge_zero_percent_calification_testcase extends local_onlinejudge_base_testcase {
    ...
    function test_change_grades() {
        ...
        $assignment = $generator->create_instance(array('course'=>$this->course->id, 
            'grade'=>100, 'testcases_grade_worth' => 0.0, 'documentation_grade_worth' => 0.0, 'indentation_grade_worth' => 0.0));
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertEquals(0, $submission_graded->grade);
