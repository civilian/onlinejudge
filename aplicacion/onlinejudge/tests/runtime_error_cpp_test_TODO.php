<?php
//TODO: This test crashes the demon
///////////////////////////////////////////////////////////////////////////
//                                                                       //
// NOTICE OF COPYRIGHT                                                   //
//                                                                       //
...
class local_onlinejudge_runtime_error_cpp_testcase extends local_onlinejudge_base_testcase {
// 
...
'
        ...
        //TODO: This test files causes that the domjudge demon crash fix this bug
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertEquals(judge_ideone::$status_judge[$row['result']], ONLINEJUDGE_STATUS_RUNTIME_ERROR);
