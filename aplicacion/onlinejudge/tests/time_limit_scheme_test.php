...
class local_onlinejudge_time_limit_scheme_testcase extends local_onlinejudge_base_testcase {

    function test_time_limit() {
        global $DB, $CFG, $DBDOM;
        $this->resetAfterTest(true);
        set_config('maxcpulimit', 1, 'local_onlinejudge');
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertEquals(judge_ideone::$status_judge[$row['result']], ONLINEJUDGE_STATUS_TIME_LIMIT_EXCEED);
