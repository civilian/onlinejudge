...
class local_onlinejudge_indentation_java_testcase extends local_onlinejudge_base_testcase {
...
*/
        ...
        args) {
                i object_i
                =new i(); object_i.sc =new 
                Scanner(System.in);
                print.
                print(object_i.sc.next());
        }               }
',
            '/print.java' => '
public 
