...
class local_onlinejudge_documentation_cpp_testcase extends local_onlinejudge_base_testcase {
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertEquals($submission_graded->grade,100);
        $submission_graded = $assignment_low_grade->get_submission($this->students[0]->id);
        $this->assertEquals($submission_graded->grade,20);
