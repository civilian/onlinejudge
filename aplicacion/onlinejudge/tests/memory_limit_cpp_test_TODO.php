...
class local_onlinejudge_memory_limit_cpp_testcase extends local_onlinejudge_base_testcase {
// 
...
int main(void)
{
    double *p = new double[2147483647];
    printf("hello");
    return 0;
}
'
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertEquals(judge_ideone::$status_judge[$row['result']], ONLINEJUDGE_STATUS_MEMORY_LIMIT_EXCEED);
