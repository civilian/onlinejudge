...
class local_onlinejudge_security_java_testcase extends local_onlinejudge_base_testcase {
// 

    function test_security_java() {
        global $DB, $CFG, $DBDOM;
...
public class mai
{
  ...
  {
    Scanner sc = new Scanner (new File ("/etc/shadow"));
