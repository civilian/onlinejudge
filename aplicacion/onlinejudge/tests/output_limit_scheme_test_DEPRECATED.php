...
class local_onlinejudge_output_limit_scheme_testcase extends local_onlinejudge_base_testcase {
    ...
    function test_output_limit() {
        ...
        $assignment = $generator->create_instance(array('course'=>$this->course->id, 
            ...
            'indentation_grade_worth' => 0.2, 'language' => 'scheme'));
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertGreaterThanOrEqual($submission_graded->grade, 40);
