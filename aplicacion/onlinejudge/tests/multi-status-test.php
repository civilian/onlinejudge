...
class local_onlinejudge_wrong_answer_cpp_testcase extends local_onlinejudge_base_testcase {
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertEquals(3, $DB->count_records('assignment_oj_submissions'));//one for each testcase
        ...
        $this->assertEquals($row['result'], array_search(ONLINEJUDGE_STATUS_WRONG_ANSWER, judge_ideone::$status_judge));
