...
class local_onlinejudge_change_grades_scheme_testcase extends local_onlinejudge_base_testcase {
// 
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertGreaterThanOrEqual(90, $submission_graded->grade);
