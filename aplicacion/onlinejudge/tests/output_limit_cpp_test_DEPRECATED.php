...
class local_onlinejudge_output_limit_cpp_testcase extends local_onlinejudge_base_testcase {
    ...
    function test_output_limit() {
        ...
        $assignment = $generator->create_instance(array('course'=>$this->course->id, 
            ...
            'indentation_grade_worth' => 0.2, 'cpulimit' => 10));
...
int main(void)
{
    ...
    freopen("../compile/program", "r", stdin);
    int i = 50;
    string a
        ("hello ápbpe hello ápbpe  hello ápbpe hello ápbpe \n");
    getline(cin,a);
...
//        ONLINEJUDGE_STATUS_ACCEPTED);
        ...
        $this->assertEquals($row['result'], array_search(ONLINEJUDGE_STATUS_OUTPUT_LIMIT_EXCEED, judge_ideone::$status_judge));        $submission_graded = $assignment->get_submission($this->students[0]->id);
