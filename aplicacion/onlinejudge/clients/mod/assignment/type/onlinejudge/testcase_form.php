...
//		$repeateloptions['outputfile']['helpbutton'] =  array('outputfile', 'assignment_onlinejudge');
        ...
        $mform->addElement('select', 'select_grade', get_string('gradefortestcases', 'assignment_onlinejudge'), $choices_grade);
        $mform->setDefault('select_grade', /*isset($onlinejudge) ? $onlinejudge->cpulimit : 4*/ 0.6);
        ...
        $mform->closeHeaderBefore('select_grade');
    }
